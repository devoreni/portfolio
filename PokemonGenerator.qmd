...
To develop the logic for EVs and Natures, tests were constructed for nearly every Pokemon archetype. The test driven development technique was then used to build a robust algorithm for detemining the nature and EVs of a Pokemon.
