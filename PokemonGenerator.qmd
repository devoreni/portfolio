...
- Individual Values
    - Each stat can have up to 31 points added to it. However, in some scenarios, lowing a stat by not giving it the full 31 may be beneficial. Examples include Hidden Power, a move where the move's type is dependent on the chosen IVs, and in situations where moving after the opponent is beneficial to gain knowledge.
